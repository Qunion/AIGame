...
# 导入基础互动模块
from src.interaction_modules.click_reveal import ClickReveal
from src.interaction_modules.clean_erase import CleanErase
from src.interaction_modules.drag_puzzle import DragPuzzle
